...
yum install httpd 
    ...
    #</dev/null
rpm --import https://download.owncloud.org/download/repositories/production/openSUSE_Leap_42.3/repodata/repomd.xml.key
zypper addrepo http://download.owncloud.org/download/repositories/production/openSUSE_Leap_42.3/ce:stable.repo
